...
UPDATED: Switched WhatsApp sender from Twilio sandbox (+14155238886)
         to verified business number (+254727209720) after Meta approval.

To deploy:
  1. Replace app.py with this file (or copy the FROM_WA change into app.py)
  2. git add app.py && git commit -m "Switch to verified WhatsApp number +254727209720" && git push
  3. Render auto-deploys on push — confirm at https://optimum-prime-lead-notifier.onrender.com/health
"""
...
# ✅ UPDATED: Verified Optimum Prime Solutions WhatsApp business number
FROM_WA     = "whatsapp:+254727209720"

# Previously (Twilio sandbox — no longer needed after Meta verification):
